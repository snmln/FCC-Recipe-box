...
import { Modal, Button, FormLabel, FormGroup, FormControl,Form } from 'react-bootstrap';
    ...
    render() {
        ...
        return (
            <Modal show={onShow} onHide={this.handleCancel} animation={false}>
                    ...
                    <Modal.Footer>
                        <Button disabled={!validRecipe} bsStyle="success" variant="success" onClick={this.handleSubmit}>Save Recipe</Button>
                    </Modal.Footer>
            </Modal>
        );
    }
...
/* <Modal show={onShow} onHide={this.handleCancel}>
                ...
                <Modal.Body>
                    ...
                    <FormGroup controlId="formControlsIngredients">
                        ...
                        <Form.label componentClass="textarea" type="text" required onChange={this.handleRecipeIngredientsChange} value={this.state.ingredients} placeholder="Enter Ingredients(separate by commas)" />
                    </FormGroup>
                </Modal.Body>
                <Modal.Footer>
